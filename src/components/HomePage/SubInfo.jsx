  ...
  return (
    <section className="italic mb-16 ">
      <div className="bg-[#f8f9fa] mb-8">
        <div className="flex justify-between py-12 px-28 flex flex-col sm:flex-row">
          <div>
      ...
      <div className="flex justify-between flex-col lg:flex-row px-3 lg:px-0">
        ...
        <form action="" className="h-12">
          <input
            type="text"
            placeholder="    Enter your email address"
            className="h-full w-80 border-gray-200 hover:border-gray-400 border-solid border-2"
          />
          <button className="h-full px-4 py-3 text-slate-50">Subscribe</button>
        </form>
      </div>
    </section>
  );
